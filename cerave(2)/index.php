      ...
      <div class="over-wrap">
        <div id="page">
          ...
          <div class="sl sl2 _show">
            <a href="#cerave2-update" class="abs sl2-links sl2-link1">
              <span class="abs">актуализация</span>
            </a>
            <a href="#cerave2-key" class="abs sl2-links sl2-link2">
              <span class="abs">ключевой<br />ингредиент</span>
            </a>
            <a href="#cerave2-gamma" class="abs sl2-links sl2-link3">
              <span class="abs">гамма</span>
            </a>
            <a href="#cerave2-scheme" class="abs sl2-links sl2-link4">
          ...
          <div class="abs m_pop1">
            <div class="abs x"></div>
            <p class="abs m_pop1-p1">Какие рекомендации, способные улучшить качество жизни пациентов с псориазом, вы могли бы дать?</p>
            <p class="abs m_pop1-p2">д.м.н., проф. Хлебникова А.Н.</p>
            <iframe id='player1' width="1024" height="575" src="https://www.youtube.com/embed/UoWfGOMjewE?enablejsapi=1" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
          </div>
