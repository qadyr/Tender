...
?>
          ...
          <div class="sl sl2">
            <a href="#dercos-update" class="abs sl2-links sl2-link1">
              <span class="abs">актуализация</span>
            </a>
            <a href="#dercos-key" class="abs sl2-links sl2-link2">
              <span class="abs">ключевой<br />ингредиент</span>
            </a>
            <a href="#dercos-gamma" class="abs sl2-links sl2-link3">
              <span class="abs">гамма</span>
            </a>
            <a href="#dercos-scheme" class="abs sl2-links sl2-link4">
              <span class="abs">схема<br />применения</span>
            </a>
            <div class="abs ovec vec1">
              <div class="abs cube cube1"></div>
              <p class="abs text text1"><b>интервью к.м.н.,<br>президента<br>союза<br>трихологов<br>каюмова с.ф.</b></p>
              <a href="#decros-video1" class="abs"></a>
            </div>
            <div class="abs ovec vec2">
              <div class="abs cube cube2"></div>
              <p class="abs text text2">КЛЮЧЕВЫЕ<br><b>ИНГРЕДИЕНТЫ</b></p>
              <a href="#decros-key2" class="abs"></a>
            </div>
            <div class="abs ovec vec3">
              <div class="abs cube cube3"></div>
              <p class="abs text text3">Гамма<br><b>Aminexil</b></p>
              <a href="#decros-gamma2" class="abs"></a>
            </div>
            <div class="abs ovec vec4">
              <div class="abs cube cube4"></div>
              <p class="abs text text4">скачать<br><b>схему<br>применения</b></p>
              <a href="https://lorealcongress.ru/files/scheme_dercos.pdf" target="_blank" class="abs"></a>
            </div>
            <div class="abs tub"></div>
          </div>
          <div class="abs m_pop1">
            <div class="abs x"></div>
            <p class="abs m_pop1-p1">Какие причины выпадения волос наиболее актуальны сегодня</p>
            <p class="abs m_pop1-p2">к.м.н., президент союза трихологов Каюмов С.Ф.</p>
            <iframe id='player1' width="1024" height="575" src="https://www.youtube.com/embed/sXJOcwYS7rQ?enablejsapi=1" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
          </div>
