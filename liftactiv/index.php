      ...
      <div class="over-wrap">
        <div id="page">
          ...
          <div class="abs m_pop2">
            ...
            <p class="abs q10">
              <b>Протокол:</b> 52 женщины, возраст 40-45 лет, типы кожи<br>от нормального до жирного, использование 2 раза в<br>день (30 дней)<br><b>Метод оценки:</b> анализ отпечатков морщин «гусиных<br>лапок» (То, Т30) при помощи программного обеспечения<br>Quantiricles (измерение линейных размеров) и Toposurf<br>3D (трехмерное сканирование)
            </p>
            <p class="abs q11">
          ...
          <div class="abs m_pop5">
            ...
            <ul class="abs list list1">
              <li>Пептиды гороха<br>и тетрапептид</li>
            </ul>
            <ul class="abs list list2">
              <li>ВИТАМИН СG 10%</li>
              <li>Эперулин</li>
